...
and matches it with a surname of notable scientists and hackers from a second list.
The result is a cool name for a new variable. Original program written in 'GO' programming language.
My challenge was to "translate" this into Python"
"""
...
surnames = [
    ...
    # Alan Boulton - an excellent mathematician, and an unbeatable programmer, a  wonderful tutor, and a unique and  precious person.
    "boulton",
